...
export function LegacyInput({ 
  ...
  const inputClasses = cn(
    "w-full text-[13px] text-slate-900 rounded-[12px] bg-slate-50/50 border border-slate-200/80",
    "px-4 py-3 font-mono shadow-[inset_0_2px_4px_rgba(0,0,0,0.02)]",
      ...
      <div className="relative">
        ...
        {isSecret && (
          <button
            ...
            className="absolute right-3 top-1/2 -translate-y-1/2 p-1.5 text-slate-400 hover:text-blue-600 transition-colors rounded-md hover:bg-blue-50"
          >
      ...
      <div className="flex items-center justify-between">
        ...
        {isSecret && multiline && (
          <button
            type="button"
            onClick={() => setShow(!show)}
            className="flex items-center gap-1.5 text-[11px] font-bold text-slate-400 hover:text-blue-600 transition-colors uppercase tracking-widest pr-1"
          >
